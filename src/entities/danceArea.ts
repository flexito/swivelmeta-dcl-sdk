...
export const danceAreas: any = [
  ...
  {
    transform: {
      position: new Vector3(8, 7.75, 4.5),
      scale: new Vector3(15, 5, 8.5)
    },
    type: 'all'
  },
  {
    transform: {
      position: new Vector3(11, 1, 8),
      scale: new Vector3(8, 3, 14)
    },
    // type: PredefinedEmote.ROBOT
    type: 'all'
  },
...
// DEBUG FLAG - Set to true to view all dance area
