...
openDialogSound.addComponent(
  new AudioSource(new AudioClip('resources/sounds/navigationForward.mp3'))
)
...
closeDialogSound.addComponent(
  new AudioSource(new AudioClip('resources/sounds/navigationBackward.mp3'))
)
...
coinSound.addComponent(
  new AudioSource(new AudioClip('resources/sounds/star-collect.mp3'))
)
